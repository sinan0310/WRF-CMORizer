...
#ln -sf /p/scratch/cjjsc39/goergen1/sim/tmp_FPSCONV/tmp_DA/simres/${DOM}_local/*/wrfout_${DOM}_${Y}* .
#ln -sf /p/scratch/cjjsc39/goergen1/sim/tmp_FPSCONV/tmp_DA/simres/${DOM}_local/*/wrfxtrm_${DOM}_${Y}* .
