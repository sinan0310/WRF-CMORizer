...
#for i in {2006,2011,2012,2013,2014} ; do
for i in {2000..2014} ; do
  ...
  export Y=$i && export DOM=d01 && sbatch --export=ALL,Y=$Y,DOM=$DOM --job-name=pCMORizer$Y$DOM pCMORizer_runctrl_allVarTypes_singleDomain_EUR15.sh
